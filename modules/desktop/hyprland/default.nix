{ lib, pkgs, browser, terminal, terminalFileManager, kbdLayout, kbdVariant, ...
}: {
  imports = [
      ...
      wayland.windowManager.hyprland = {
        ...
        settings = {
          ...
          exec-once = [
            ...
            } --type text --watch cliphist store" # clipboard store text data
            "${
              getExe' pkgs.wl-clipboard "wl-paste"
            } --type image --watch cliphist store" # clipboard store image data
          ...
          misc = {
            ...
            vrr =
              1; # enable variable refresh rate (0=off, 1=on, 2=fullscreen only)
          };
          ...
          bind =
            let autoclicker = pkgs.callPackage ./scripts/autoclicker.nix { };
            in [
              # Keybinds help menu
              ...
              "$mainMod, F8, exec, kill $(cat /tmp/auto-clicker.pid) 2>/dev/null || ${
                lib.getExe autoclicker
              } --cps 40"
              # "$mainMod ALT, mouse:276, exec, kill $(cat /tmp/auto-clicker.pid) 2>/dev/null || ${lib.getExe autoclicker} --cps 60"

              # Night Mode (lower value means warmer temp)
              "$mainMod, F9, exec, ${
                getExe pkgs.hyprsunset
              } --temperature 3500" # good values: 3500, 3000, 2500
              "$mainMod, F10, exec, pkill hyprsunset"

              # Window/Session actions
              "$mainMod, Q, exec, ${
                ./scripts/dontkillsteam.sh
              ...
              "$mainMod, A, exec, pkill -x rofi || ${
                ./scripts/rofi.sh
              } drun" # launch desktop applications
              "$mainMod, SPACE, exec, pkill -x rofi || ${
                ./scripts/rofi.sh
              } drun" # launch desktop applications
              ...
              } s" # drag to snip an area / click on a window to print it
              "$mainMod CTRL, P, exec, ${
                ./scripts/screenshot.sh
              } sf" # frozen screen, drag to snip an area / click on a window to print it
              "$mainMod, print, exec, ${
                ./scripts/screenshot.sh
              } m" # print focused monitor
              "$mainMod ALT, P, exec, ${
                ./scripts/screenshot.sh
              } p" # print all monitor outputs
              ...
              in [
                ...
                "$mainMod CTRL, ${ws}, movetoworkspacesilent, ${
                  toString (x + 1)
                }"
              ]) 10));
          bindm = [
